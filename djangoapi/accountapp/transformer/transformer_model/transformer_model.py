...
with open('./accountapp/transformer/data/src_200000man_vocab.pkl', 'rb') as f:
    SRC.vocab = torch.load(f)
with open('./accountapp/transformer/data/trg_40000man_vocab.pkl', 'rb') as f:
    TRG.vocab = torch.load(f)
